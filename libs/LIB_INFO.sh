...
GPERF_VERSION=3.1
GPERF_DL_ADDR=http://ftpmirror.gnu.org/gperf/gperf-$GPERF_VERSION.tar.gz
export GPERF_TARBALL_NAME=$(basename "$GPERF_DL_ADDR")
export GPERF_FOLDER_NAME="${GPERF_TARBALL_NAME%.*.*}"

LIBFREETYPE_VERSION=2.8.1
