...
LIBXML2_DL_ADDR=ftp://gd.tuwien.ac.at/pub/libxml/libxml2-$LIBXML2_VERSION.tar.gz
...
GLIB_MAJOR_VERSION=2.45
GLIB_VERSION=2.45.1
GLIB_DL_ADDR=https://download.gnome.org/sources/glib/$GLIB_MAJOR_VERSION/glib-$GLIB_VERSION.tar.xz
...
LIBCROCO_MAJOR_VERSION=0.6
LIBCROCO_VERSION=0.6.8
LIBCROCO_DL_ADDR=https://download.gnome.org/sources/libcroco/$LIBCROCO_MAJOR_VERSION/libcroco-$LIBCROCO_VERSION.tar.xz
...
ATK_MAJOR_VERSION=2.16
ATK_VERSION=2.16.0
ATK_DL_ADDR=https://download.gnome.org/sources/atk/$ATK_MAJOR_VERSION/atk-$ATK_VERSION.tar.xz
...
LIBPNG_DL_ADDR=http://sourceforge.net/projects/libpng/files/libpng16/$LIBPNG_VERSION/libpng-$LIBPNG_VERSION.tar.xz
export LIBPNG_TARBALL_NAME=$(basename "$LIBPNG_DL_ADDR")
export LIBPNG_FOLDER_NAME="${LIBPNG_TARBALL_NAME%.*.*}"

LIBJPEG_TURBO_VERSION=1.4.0
LIBJPEG_TURBO_DL_ADDR=http://sourceforge.net/projects/libjpeg-turbo/files/$LIBJPEG_TURBO_VERSION/libjpeg-turbo-$LIBJPEG_TURBO_VERSION.tar.gz
...
GDK_PIXBUF_MAJOR_VERSION=2.31
GDK_PIXBUF_VERSION=2.31.4
GDK_PIXBUF_DL_ADDR=https://download.gnome.org/sources/gdk-pixbuf/$GDK_PIXBUF_MAJOR_VERSION/gdk-pixbuf-$GDK_PIXBUF_VERSION.tar.xz
export GDK_PIXBUF_TARBALL_NAME=$(basename "$GDK_PIXBUF_DL_ADDR")
export GDK_PIXBUF_FOLDER_NAME="${GDK_PIXBUF_TARBALL_NAME%.*.*}"

LIBFREETYPE_VERSION=2.5.5
LIBFREETYPE_DL_ADDR=http://sourceforge.net/projects/freetype/files/freetype2/$LIBFREETYPE_VERSION/freetype-$LIBFREETYPE_VERSION.tar.bz2
export LIBFREETYPE_TARBALL_NAME=$(basename "$LIBFREETYPE_DL_ADDR")
export LIBFREETYPE_FOLDER_NAME="${LIBFREETYPE_TARBALL_NAME%.*.*}"

LIBFONTCONFIG_VERSION=2.11.93
...
CAIRO_DL_ADDR=http://cairographics.org/releases/cairo-$CAIRO_VERSION.tar.xz
export CAIRO_TARBALL_NAME=$(basename "$CAIRO_DL_ADDR")
export CAIRO_FOLDER_NAME="${CAIRO_TARBALL_NAME%.*.*}"

PANGO_MAJOR_VERSION=1.36
PANGO_VERSION=1.36.8
PANGO_DL_ADDR=https://download.gnome.org/sources/pango/$PANGO_MAJOR_VERSION/pango-$PANGO_VERSION.tar.xz
export PANGO_TARBALL_NAME=$(basename "$PANGO_DL_ADDR")
export PANGO_FOLDER_NAME="${PANGO_TARBALL_NAME%.*.*}"

GTK_MAJOR_VERSION=3.17
GTK_VERSION=3.17.1
GTK_DL_ADDR=https://download.gnome.org/sources/gtk+/$GTK_MAJOR_VERSION/gtk+-$GTK_VERSION.tar.xz
export GTK_TARBALL_NAME=$(basename "$GTK_DL_ADDR")
export GTK_FOLDER_NAME="${GTK_TARBALL_NAME%.*.*}"

LIBRSVG_MAJOR_VERSION=2.40
LIBRSVG_VERSION=2.40.9
LIBRSVG_DL_ADDR=https://download.gnome.org/sources/librsvg/$LIBRSVG_MAJOR_VERSION/librsvg-$LIBRSVG_VERSION.tar.xz
...
ADWAITA_MAJOR_VERSION=3.16
ADWAITA_VERSION=3.16.2
ADWAITA_ICON_THEME_DL_ADDR=https://download.gnome.org/sources/adwaita-icon-theme/$ADWAITA_MAJOR_VERSION/adwaita-icon-theme-$ADWAITA_VERSION.tar.xz
...
LIBSIGCPP_MAJOR_VERSION=2.4
LIBSIGCPP_VERSION=2.4.1
LIBSIGCPP_DL_ADDR=https://download.gnome.org/sources/libsigc++/$LIBSIGCPP_MAJOR_VERSION/libsigc++-$LIBSIGCPP_VERSION.tar.xz
export LIBSIGCPP_TARBALL_NAME=$(basename "$LIBSIGCPP_DL_ADDR")
export LIBSIGCPP_FOLDER_NAME="${LIBSIGCPP_TARBALL_NAME%.*.*}"

GLIBMM_MAJOR_VERSION=2.44
GLIBMM_VERSION=2.44.0
GLIBMM_DL_ADDR=https://download.gnome.org/sources/glibmm/$GLIBMM_MAJOR_VERSION/glibmm-$GLIBMM_VERSION.tar.xz
export GLIBMM_TARBALL_NAME=$(basename "$GLIBMM_DL_ADDR")
export GLIBMM_FOLDER_NAME="${GLIBMM_TARBALL_NAME%.*.*}"

ATKMM_MAJOR_VERSION=2.22
ATKMM_VERSION=2.22.7
ATKMM_DL_ADDR=https://download.gnome.org/sources/atkmm/$ATKMM_MAJOR_VERSION/atkmm-$ATKMM_VERSION.tar.xz
export ATKMM_TARBALL_NAME=$(basename "$ATKMM_DL_ADDR")
export ATKMM_FOLDER_NAME="${ATKMM_TARBALL_NAME%.*.*}"

CAIROMM_VERSION=1.11.2
...
PANGOMM_MAJOR_VERSION=2.36
PANGOMM_VERSION=2.36.0
PANGOMM_DL_ADDR=https://download.gnome.org/sources/pangomm/$PANGOMM_MAJOR_VERSION/pangomm-$PANGOMM_VERSION.tar.xz
export PANGOMM_TARBALL_NAME=$(basename "$PANGOMM_DL_ADDR")
export PANGOMM_FOLDER_NAME="${PANGOMM_TARBALL_NAME%.*.*}"

GTKMM_MAJOR_VERSION=3.16
GTKMM_VERSION=3.16.0
GTKMM_DL_ADDR=https://download.gnome.org/sources/gtkmm/$GTKMM_MAJOR_VERSION/gtkmm-$GTKMM_VERSION.tar.xz
