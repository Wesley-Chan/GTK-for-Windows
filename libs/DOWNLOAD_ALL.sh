...
GLIB_DL_ADDR=https://download.gnome.org/sources/glib/2.41/glib-2.41.5.tar.xz
...
GTK_DL_ADDR=https://download.gnome.org/sources/gtk+/3.13/gtk+-3.13.8.tar.xz
...
ADWAITA_ICON_THEME_DL_ADDR=https://download.gnome.org/sources/adwaita-icon-theme/3.13/adwaita-icon-theme-3.13.91.tar.xz
...
GLIBMM_DL_ADDR=https://download.gnome.org/sources/glibmm/2.41/glibmm-2.41.4.tar.xz
...
GTKMM_DL_ADDR=https://download.gnome.org/sources/gtkmm/3.13/gtkmm-3.13.8.tar.xz
