...
GLIB_DL_ADDR=https://download.gnome.org/sources/glib/2.40/glib-2.40.0.tar.xz
...
GDK_PIXBUF_DL_ADDR=https://download.gnome.org/sources/gdk-pixbuf/2.30/gdk-pixbuf-2.30.7.tar.xz
...
GTK_DL_ADDR=https://download.gnome.org/sources/gtk+/3.12/gtk+-3.12.0.tar.xz
