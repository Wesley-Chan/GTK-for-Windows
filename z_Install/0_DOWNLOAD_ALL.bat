...
set filename=i686-4.8.2-release-win32-sjlj-rt_v3-rev4.7z
set dladdr=http://sourceforge.net/projects/mingw-w64/files/Toolchains%%20targetting%%20Win32/Personal%%20Builds/mingw-builds/4.8.2/threads-win32/sjlj/i686-4.8.2-release-win32-sjlj-rt_v3-rev4.7z/download
